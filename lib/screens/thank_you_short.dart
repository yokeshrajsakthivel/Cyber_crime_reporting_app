...
class ThankYouShort extends StatelessWidget {
  const ThankYouShort({super.key});
    ...
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: [
            const Text(
              "Thank you for your report. Your submission has been received successfully. If you need urgent help, please contact 1930.",
